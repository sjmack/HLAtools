...
In all version 3.*.* releases, nucleotide alignments for the DRB6, DRB7, DRB8 or DRB9 genes are included in the 'DRB_nuc.txt' file.  

As noted above, when building alignments for past releases, the *HLAgazeteer* should be updated to reflect the available gene names in that release, and consulted to determine which gene names should be provided to alignmentFull(). 
...
# 4. Working with Genotype List String (GL String), GL String Code (GLSC), and UNIFORMAT Data
