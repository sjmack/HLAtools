...
- Updated buildAlignments() to build HLA-N, -S and -U cDNA alignments in releases prior to 3.36.0.
- Updated buildAlignments() to build HLA-Y alignments in releases prior to 3.32.0.
